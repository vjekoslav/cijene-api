...
class Product(BaseModel):
    ...
    initial_price: Optional[Decimal] = None  # Initial price for newly added products (if available)
    date_added: Optional[Decimal] = None     # When the product was added (if available)
